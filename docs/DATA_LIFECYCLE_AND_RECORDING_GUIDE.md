...
| `whip1_001/002/003` in adaptation0 | Temporary bootstrap drone nominal/residual and cable physics/residual data | Latest phase-aware version is `20260908-041031-260837`. The subsequent [nominal-only fit](NOMINAL_DRONE_FIT_RESULTS_20260908.md) consumes explicit masks but reveals attitude-domain/post-hold limitations. Residual/cable stages remain pending. |
