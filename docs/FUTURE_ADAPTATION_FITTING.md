...
Current completed run: [M1-full to M2](M1_TO_M2_ADAPTATION.md),
...
Current real trial: [M0/M1 first adaptation](M0_M1_FIRST_ADAPTATION.md). One nominal
...
**Current whip workflow:** read [M0→M1 preparation](M0_TO_M1_ADAPTATION.md).
...
**Current experiment reset:** the repaired 145 g drone / 17 g cable workspace starts empty. Previous runs and data below are archived historical evidence. Read [NEW_SYSTEM_CHECK.md](NEW_SYSTEM_CHECK.md) and [HANDOFF.md](../HANDOFF.md) before acting on old run instructions.
