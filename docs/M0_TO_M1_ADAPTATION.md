...
The current project-level scope is [drone, cable and residual adaptation](ADAPTATION_MODEL_CONTRACT.md).
...
The [drone-command chain audit](DRONE_COMMAND_CHAIN_AUDIT.md) verifies the exact
...
For repeated rounds and the new UI, read [sim-real evaluation](SIM_REAL_EVALUATION.md).
...
The [drone-response literature/math review](DRONE_RESPONSE_ADAPTATION.md) now
...
[the evaluation guide](SIM_REAL_EVALUATION.md). SimOpt motivates alternating real
...
```powershell
$batch = 'rehearsal_csv_and_result_in_real_flight/M0_whip_20260910-022818-648386'
