...
![Pilot comparison](../runs/audits/preliminary1-cable-only-pilot/comparison.png)
...
![Figure-eight midpoint](../runs/audits/preliminary1-cable-only-pilot/figure8_midpoint.png)
...
[Saved run](../runs/audits/preliminary1-cable-only-pilot/) contains `protocol.json`,
