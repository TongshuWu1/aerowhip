...
5.76/4.54/5.92 m/s. Read the M2 flight review (`runs/data_review/M2-whip-intake-20260910/README.md`, not included in this source-only release).
...
frozen package (`runs/flight_packages/20260910-211435-608306/README.md`, not included in this source-only release) contains
...
Read the M1 real-flight review (`runs/data_review/M1-whip-intake-20260910/README.md`, not included in this source-only release).
...
`runs/flight_packages/20260910-181929-716218` (`runs/flight_packages/20260910-181929-716218/README.md`, not included in this source-only release).
...
planning comparison and checks (`runs/audits/M1-full-mppi-contact-20260910/README.md`, not included in this source-only release).
...
intake review (`runs/data_review/M0-whip-intake-20260910/README.md`, not included in this source-only release), including
...
Use selected take instructions (`runs/flight_packages/20260910-022818-648386/README.md`, not included in this source-only release)
