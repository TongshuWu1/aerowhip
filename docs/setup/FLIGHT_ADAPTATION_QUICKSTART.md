...
Read [data lifecycle](../methods/DATA_LIFECYCLE_AND_RECORDING_GUIDE.md),
[adaptation comparison](../methods/ADAPTATION_CHECK.md), [height normalization](../methods/HOVER_HEIGHT_CALIBRATION.md),
and [future fitting requirements](../methods/FUTURE_ADAPTATION_FITTING.md) for details.

Current planning/export uses [direct PVA](../methods/DIRECT_PVA_WORKFLOW.md). Acceleration
