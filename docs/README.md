...
- [Publication preparation and source release](PUBLICATION.md)
...
- [Paper experiment protocol](PAPER_EXPERIMENT_PROTOCOL.md)
- [Adaptation related work](ADAPTATION_RELATED_WORK_20260905.md)
- [Detailed literature review](RELATED_PAPERS_DETAILED_REVIEW.md)

Dated audits, development notes and measured/synthetic result reports are in [history/](history/). They describe the settings and evidence at their original dates and are not current launch instructions. Active configuration and project context take precedence over older timing, reward, UI or fitting descriptions.
