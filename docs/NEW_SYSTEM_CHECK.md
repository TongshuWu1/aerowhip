...
Read [PAPER_PIPELINE_AUDIT.md](PAPER_PIPELINE_AUDIT.md) and [PAPER_EXPERIMENT_PROTOCOL.md](PAPER_EXPERIMENT_PROTOCOL.md) first
...
See [M2 MPPI results](M2_AGGRESSIVE_MPPI.md). No flight or promotion occurred.

Latest: the user-authorized [M2 aggressive MPPI](M2_AGGRESSIVE_MPPI.md) completed.
...
Latest: [M2 regression analysis](M2_REGRESSION_ANALYSIS.md) is complete. Frozen
...
[the M2 data, fitting and planning contract](M1_TO_M2_ADAPTATION.md).
...
Current: [full model adaptation](FULL_MODEL_ADAPTATION.md) completed as
...
[model contract](ADAPTATION_MODEL_CONTRACT.md). The available M1 is only a partial
...
The [first partial real adaptation](M0_M1_FIRST_ADAPTATION.md) is complete. A single drone
...
Latest: [drone-response adaptation review](DRONE_RESPONSE_ADAPTATION.md) adds
...
Latest: [model evolution and evaluation UI](SIM_REAL_EVALUATION.md) supports
...
Latest: [M0â†’M1 preparation and audit](M0_TO_M1_ADAPTATION.md) is ready for
reviewed new flight data. Inbox `M0_whip_20260910-022818-648386/flight_take` under
`rehearsal_csv_and_result_in_real_flight` is empty. Original flight package/forecast
...
Read the implementation section in [success review](WHIP_SUCCESS_CONDITION_REVIEW.md)
...
Read [success-condition review](WHIP_SUCCESS_CONDITION_REVIEW.md). Geometric
...
Latest: the [timing/strength search trial](MPPI_TIMING_SEARCH.md) completed with
...
Latest: the [preferred-fold objective and one trial](MPPI_PREFERRED_FOLD.md) completed.
...
Latest: [preferred-wave review](WHIP_WAVE_REWARD_REVIEW.md) is complete. The user
...
latest HANDOFF and [trial details](MPPI_WHOLE_WHIP.md). No optimizer, fit or flight
is currently authorized to start automatically. Launch notes below are historical.

Latest 10 September 01:17: user-authorized [whole-whip MPPI](MPPI_WHOLE_WHIP.md)
...
10 September update: [gradient and damping investigation](PRELIMINARY1_DAMPING_RESOLUTION.md)
...
[cable-only pilot](PRELIMINARY1_CABLE_PILOT.md) following the literature review.
...
See [method comparison and proposed next steps](PRELIMINARY1_METHOD_COMPARISON.md)
...
under the user's subsequent authorization. See [preliminary1 fit details](PRELIMINARY1_FIT.md)
