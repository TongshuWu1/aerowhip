...
Read [the current system comparison](M0_M1_M2_SYSTEM_COMPARISON.md) for exact
...
`runs/evaluation/M0-M1-M2-system-review-20260910-v2/docs_before/docs/SIM_REAL_EVALUATION.md`.
...
[the integrated adaptation procedure](M0_TO_M1_ADAPTATION.md).
