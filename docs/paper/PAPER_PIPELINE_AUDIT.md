...
`runs/audits/paper-pipeline-audit-20260911` (`runs/audits/paper-pipeline-audit-20260911/README.md`, not included in this source-only release).
...
The [frozen method](../methods/FROZEN_SYSTEM_IDENTIFICATION.md) specifies all bounds,
...
Source: the hash-bound [system comparison](../development/M0_M1_M2_SYSTEM_COMPARISON.md) and
`report.json` (`runs/evaluation/M0-M1-M2-system-review-20260910-v2/report.json`, not included in this source-only release).
...
`launch_and_task_window.json` (`runs/audits/paper-pipeline-audit-20260911/launch_and_task_window.json`, not included in this source-only release).
...
Source: `numerical_refinement.json` (`runs/audits/paper-pipeline-audit-20260911/numerical_refinement.json`, not included in this source-only release).
