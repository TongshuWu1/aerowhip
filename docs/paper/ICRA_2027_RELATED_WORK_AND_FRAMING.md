...
[^29]: Project primary audit and proposed protocol. [Aerial whipping: whole-system paper audit](../../delete/cleanup-20260913/docs/paper/PAPER_PIPELINE_AUDIT.md) and [Clean aerial-whip experiment: protocol release candidate 1](PAPER_EXPERIMENT_PROTOCOL.md), 11 September 2026. Selected model [record](../../delete/cleanup-20260913/runs/adaptation/M2-frozen-refit-v1/candidate/model.json); offline optimizer [implementation](../../planning/mppi_trajectory.py). The protocol is not yet released for clean collection.

[^30]: Project primary evaluation. [M0 → M1 → M2 system comparison](../../delete/cleanup-20260913/docs/development/M0_M1_M2_SYSTEM_COMPARISON.md), 10 September 2026, especially model-class history and comparison definitions; [checksummed numerical report](../../delete/cleanup-20260913/runs/evaluation/M0-M1-M2-system-review-20260910-v2/report.json) and [per-take tables](../../delete/cleanup-20260913/runs/evaluation/M0-M1-M2-system-review-20260910-v2/TABLES.md). Current recordings are development evidence.

[^31]: Project PPO supervisor [completion status](../../delete/cleanup-20260913/runs/audits/M2-ppo-persistent-20260911/status.json), read 11 September 2026; final best checkpoint, independent preview, recovery result and stop reason. This supersedes older still-running handoff notes for that job. No physical PPO validation is reported.
