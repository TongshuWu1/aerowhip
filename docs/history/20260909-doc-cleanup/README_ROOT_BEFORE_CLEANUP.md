...
Read [the current PVA design](../../DIRECT_PVA_WORKFLOW.md) and [implementation/worker status](PVA_IMPLEMENTATION_PROGRESS.md). Historical force policies and old 20/30 Hz workflows remain preserved; their checkpoints cannot be reinterpreted as jerk policies. Independent Isaac/PhysX development is paused.

For manuscript work or onboarding a separate writing agent, start with the detailed [paper-writing handoff](../../PAPER_WRITING_HANDOFF.md): technical method, equations, candidate contributions, experiment lineage, verified results, limitations, and source/artifact links.

## Start here

For the current Windows/Ubuntu lab transfer, read [HANDOFF.md](../../../HANDOFF.md) and
[lab setup](../../LAB_SETUP.md). The selected PPO can be transferred without retraining.
...
For a new environment, start with [installation](../../INSTALL.md). For a source-only
research release, see [publication preparation](../../PUBLICATION.md). The release
...
- [Tomorrow’s flight/adaptation guide](../../FLIGHT_ADAPTATION_QUICKSTART.md)
- [Current decisions and active comparison](PROJECT_CONTEXT.md)
- [Research proposal](../../RESEARCH_PROPOSAL_ADAPTIVE_AERIAL_WHIP.md)
