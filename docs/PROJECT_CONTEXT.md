...
The previous running decision log is retained in [history](history/PROJECT_CONTEXT_BEFORE_LAB_TRANSFER_20260906.md). Its older requests, artifact locations and active-run descriptions are historical, not current instructions.
