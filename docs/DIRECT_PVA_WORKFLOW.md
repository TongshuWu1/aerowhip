...
acceleration at 30 Hz. Read [the paper handoff](PAPER_WRITING_HANDOFF.md) for exact
...
Use [M0→M1 adaptation](M0_TO_M1_ADAPTATION.md) for the reviewed raw-data steps and
