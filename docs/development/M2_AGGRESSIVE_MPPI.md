...
`20260910-211435-608306` (`runs/flight_packages/20260910-211435-608306/README.md`, not included in this source-only release).
...
1,600-weight result (`runs/audits/M2-impact1600-20260910/README.md`, not included in this source-only release).
...
result report (`runs/audits/M2-aggressive-mppi-20260910/README.md`, not included in this source-only release).
