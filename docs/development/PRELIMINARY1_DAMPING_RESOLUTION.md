...
Results (`runs/audits/preliminary1-gradient-resolution/comparison.png`, not included in this source-only release)
...
Candidate model (`runs/audits/preliminary1-gradient-resolution/candidate/model.json`, not included in this source-only release)
