...
Matched model comparison (`runs/evaluation/M0-M1-M2-system-review-20260910-v2/latest_paired_models.png`, not included in this source-only release)

All numbers are reproducible from the checksummed review (`runs/evaluation/M0-M1-M2-system-review-20260910-v2/report.json`, not included in this source-only release).
The complete per-take tables (`runs/evaluation/M0-M1-M2-system-review-20260910-v2/TABLES.md`, not included in this source-only release)
...
Prospective flight results (`runs/evaluation/M0-M1-M2-system-review-20260910-v2/prospective_flights.png`, not included in this source-only release)
...
Per-take prediction traces (`runs/evaluation/M0-M1-M2-system-review-20260910-v2/latest_prediction_traces.png`, not included in this source-only release)
...
The UI data is explicitly registered (`config/evaluation/system_review.json`, not included in this source-only release)
