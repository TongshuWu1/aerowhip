...
Take 005 attachment motion and tip height (`runs/audits/M2-regression-analysis-20260910/why_tip_rises.png`, not included in this source-only release)
...
Evidence: audit and reproducible scripts (`runs/audits/M2-regression-analysis-20260910/README.md`, not included in this source-only release),
[original M2 fit report](M1_TO_M2_ADAPTATION.md), and
exact saved-error decomposition (`runs/audits/M2-full-adaptation-20260910/combined_error.json`, not included in this source-only release).
