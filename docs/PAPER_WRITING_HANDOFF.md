...
Read [the frozen method](FROZEN_SYSTEM_IDENTIFICATION.md) for exact loss scales,
...
- [Development system comparison](M0_M1_M2_SYSTEM_COMPARISON.md)
- [Full-model adaptation](FULL_MODEL_ADAPTATION.md)
- [M2 regression mechanisms](M2_REGRESSION_ANALYSIS.md)
