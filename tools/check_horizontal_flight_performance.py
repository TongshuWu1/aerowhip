"""Compare measured M5/M6 horizontal executions against one desired motion.
...
COLLECTIONS = {'M5':'M5-curved-side','M6':'M6-horizontal'}
...
def main():
    ...
    contract=dict(evidence='Actual OptiTrack tip measurements; desired trajectory is the saved M5 simulation.',
        ...
        label_policy='Current active naming: former M7 is now M6. The omitted intermediate model and original recording names remain documented in the renaming archive. Displayed M5 to M6 does not imply a single model-update round.',
        ...
        recovery_note='M6 session 1 whip 4 has a partial recovery tail; its complete scored maneuver is included.')
...
if __name__=='__main__':
    ...
    parser.add_argument('--m5-m7-as-m5-m6',action='store_true',help='Compatibility flag: former M7 is now the actual M6 collection.')
