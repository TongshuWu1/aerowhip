"""Locally invert finalized M1 toward the original M0 planned physical motion using M2."""
...
def main():
    ...
    job=ROOT/'runs/reference_tracking'/('M2-local-'+stamp)
    ...
    try:
        ...
        status('Checking latest executed M1 command under M2')
        ...
        output=ROOT/'runs/rehearsals_pva'/f'{stamp}-M2-local-fixed-tip-reference'
        ...
        summary=dict(schema='pva_fullstate_30hz_v1',planner='Local M2 fixed-reference command correction',
        ...
        export=ROOT/'exports/M2_local_fixed_tip_reference';export.mkdir(exist_ok=False)
        ...
        (export/'README.md').write_text(
            '# M2 local fixed-tip-reference command\n\n'
            ...
            'Commands are corrected with M2 to track the original M0 predicted tip\n'
