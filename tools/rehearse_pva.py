...
if __name__=='__main__':
    ...
    p.add_argument('--origin',nargs=3,type=float);p.add_argument('--target',nargs=3,type=float)
    ...
    generate(a.job,a.output,origin=a.origin,target=a.target,device=a.device,progress=progress)
