...
def fit(job,device='cuda'):
    ...
    try:
        ...
        atomic_json(job/'status.json',dict(status='completed',stage='M4 fit complete with standard stopping; performance comparison deferred',
...
if __name__=="__main__":
    fit(Path(__file__).resolve().parents[1]/"runs/adaptation/M4-20260915")
