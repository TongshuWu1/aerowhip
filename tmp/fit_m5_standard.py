...
def fit(job,device='cuda'):
    ...
    try:
        ...
        atomic_json(job/'status.json',dict(status='completed',stage='M5 fit complete with standard stopping; performance comparison deferred',
...
if __name__=="__main__":
    fit(Path(__file__).resolve().parents[1]/"runs/adaptation/M5-20260915")
