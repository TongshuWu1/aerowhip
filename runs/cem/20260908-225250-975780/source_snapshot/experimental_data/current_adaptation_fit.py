...
def drone_run(job=JOB):
    ...
    for label,training,heldout in folds(names):
        ...
        net=engine.drone.residual;start=deepcopy(net.state_dict());batch=WeightedTranslationBatch([trials[n] for n in training],params)
        ...
        net.load_state_dict(best);net.requires_grad_(False);save_residual(folder/'drone_residual.pt',net)
