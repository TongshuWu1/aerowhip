...
class DiagnosticsPage(QWidget):
    def __init__(self,root):
        ...
        self.tabs.addTab(self.model,'Model validation');self.tabs.addTab(self.recordings,'Flight plan vs actual')
...
class RecordingsWorkspace(QWidget):
    def __init__(self,root):
        ...
        self.rounds=RecordingRoundsPage(root);tabs.addTab(self.rounds,'Flight rounds')
        ...
        layout.addWidget(note('1. Start the controller logger and OptiTrack recording.\n\n'
            ...
            '5. Preserve the native take, 100 Hz cf_7 position/quaternion, cable1 C1–C10, controller log, exact CSV, target and contact/intervention notes.\n\n'
