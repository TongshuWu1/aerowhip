...
class CEMPage(QWidget):
    def __init__(self,root,optimizer='cem'):
        ...
        self.start=QPushButton(f'Optimize with {self.planner}');self.start.setObjectName('primaryButton');self.start.clicked.connect(self.start_run);form.addRow(self.start)
