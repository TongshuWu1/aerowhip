...
PAGE_DEFINITIONS = (
    ...
    ('MPPI Planner', 'Optimize with M1 using offline path-integral sampling; rehearse and export at 30 Hz'),
...
class SimulatorMainWindow(QMainWindow):
    ...
    def _page_changed(self, index):
        ...
        if index==5:
            self.model_status.setText('MPPI uses its selected model JSON (M1 default) · offline spline planning → 30 Hz FullState · separate from PPO')
        else:
