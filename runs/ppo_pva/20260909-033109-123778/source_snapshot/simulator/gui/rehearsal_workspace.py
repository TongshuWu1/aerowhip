...
class RehearsalWorkspace(QWidget):
    ...
    def load_result(self,directory):
        ...
        if self.metadata.get('schema') not in ('research_fullstate_30hz_v1','cem_fullstate_30hz_v1','mppi_fullstate_30hz_v1','mppi_force_fullstate_30hz_v1'):raise ValueError('Select a completed native 30 Hz rehearsal folder.')
