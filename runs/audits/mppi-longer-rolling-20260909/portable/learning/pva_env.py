...
def defaults(method='ppo'):
    ...
    if method=='mppi':
        cfg['task']['duration_s']=5.
        cfg['mppi'].update(mode='receding',horizon_s=.4,noise_std=.3,temperature=1.,minimum_iterations=3,patience=3,
            control_prior=0.,terminal_distance=10.,terminal_velocity=2.,terminal_anchor=30.,terminal_command_speed=.1,terminal_command_acceleration=.01)
    return cfg
