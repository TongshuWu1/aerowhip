...
if __name__=='__main__':
    ...
    page.result_scope.setCurrentIndex(1)  # Explicit historical replay; never relabel old results.
    ...
    direct=page.preview.metadata.get('schema')=='mppi_force_fullstate_30hz_v1'
    assert ('virtual_force_n' in page.preview.arrays)==direct
    ...
    atomic_json(output/'verification.json',dict(pages=7,adaptation_check_index=6,cem_page_removed=True,
        ...
        native_viewer=True,csv_rows=page.preview.table.rowCount(),direct_force_output=direct))
