...
def initialize_from_hover(time_s,positions,rotations,commands,parameters,*,
    ...
    if alignment_mode=='prehover_effective_alignment':
        ...
        command_rotation=command_attitude(mean_a,commands[:,0,9],parameters.gravity_m_s2)
...
def derivatives(state,command,parameters):
    ...
    desired=command_attitude(acceleration,command[:,9],parameters.gravity_m_s2)@state.rotation_command_from_tracking
