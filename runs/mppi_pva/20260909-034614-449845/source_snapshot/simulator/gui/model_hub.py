...
class ModelHub(QWidget):
    ...
    def __init__(self,root):
        ...
        body.addWidget(note('Select a reviewed batch, then fit both models and residuals. The current workflow uses five free-flight takes of the original M0 sequence. Your one repeat take can first be checked in Adaptation Check.'))
    ...
    def refresh(self):
        ...
        self.models.addItem('M0 · current research workspace',str((self.root/'config/research_30hz/model.json').resolve()))
    ...
    def inspect_model(self):
        ...
        mass=model.get('mass_measurement',{})
