...
if __name__=='__main__':
    ...
    output=root/'runs/mppi/20260908-M1-independent-force-check'
    ...
    settings=dict(DEFAULTS,**read_json(root/'config/mppi.json'));settings.update(population=16,iterations=2,display_name='M1 independent MPPI integration check')
