...
def main():
    ...
    receipt=dict(csv_sha256=summary['csv_sha256'],rows=len(rows),rate_hz=30,duration_s=float(t[-1]),
        finalized_M1_identity_unchanged=True,original_reference_hash_verified=True,
        ...
        ui_status=message,hardware='Windows; optimizer ran on RTX 4080',physical_M1_flight_performed=False)
