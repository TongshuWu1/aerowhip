...
|---:|---:|:---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 42 | 30 | False | 0.0220 | — | 0.939 | 40.35 | 1.706 | 0.488 | 1.815 | 156.5 |
| 43 | 30 | False | 0.0151 | — | 0.966 | 46.15 | 2.207 | 0.478 | 2.100 | 157.6 |
| 44 | 30 | False | 0.0145 | — | 0.942 | 45.18 | 1.917 | 0.498 | 2.203 | 157.0 |
| 45 | 30 | False | 0.0188 | — | 0.921 | 39.15 | 1.860 | 0.497 | 2.018 | 158.3 |
| 46 | 30 | False | 0.0104 | — | 0.978 | 46.12 | 2.865 | 0.497 | 2.122 | 158.0 |
| 47 | 30 | False | 0.0117 | — | 0.964 | 41.03 | 2.002 | 0.427 | 1.910 | 157.8 |

Final seed: **47**. Selection class: **best_feasible_near_miss**. Successful feasible plans, when present, were ranked by target-center accuracy, then direction, then feasibility margin; duration was only a weak tie-breaker.

## Deterministic replay and numerical consistency

- Optimized duration: 0.9638 s (INTERIOR).
- First valid hit: NONE.
- Tip error: 11.654 mm.
- Tip total speed: 2.654 m/s.
- Directed tip speed: 2.002 m/s.
- Direction error: 41.035 deg.
- First target-entry marker: c10.
- UAV maximum displacement: 0.4266 m.
- UAV maximum speed: 1.9097 m/s.
- Maximum command acceleration: 15.3988 m/s².
- Tip/UAV speed ratio at event: 2.193.
- Candidate/replay consistency: **PASS**.

| Hard gate | Result |
|---|:---:|
| command_acceleration | PASS |
| directed_tip_speed | FAIL |
| finite | PASS |
...
- Campaign runtime: 947.16 s.
- Candidate rollouts: 1474560.
- Effective rollouts/s: 1556.8.
- Peak CUDA memory: 41.8 MB.
- Result directory: `C:\Users\wts28\Documents\PHD\particle_filter_cable_project\data\planning_results\canonical_whip_variable_duration_v1\2026-08-29T064724.928534Z`.
- Video: `C:\Users\wts28\Documents\PHD\particle_filter_cable_project\data\planning_results\canonical_whip_variable_duration_v1\2026-08-29T064724.928534Z\canonical_whip_variable_duration_v1_final_replay.mp4`.
...
- Milestone 4C preflight: **6 passed**.
- Full repository regression suite: **67 passed**.
- Python compilation: **PASS**.
- `git diff --check`: **PASS** (line-ending notices only; no whitespace errors).
- Planning-page offscreen smoke: **PASS**; the saved CEM result displays `FAIL`, optimized duration, and an enabled replay/video workflow without exposing a hardware action.
...
## Final summary
    ...
    Video:
        C:\Users\wts28\Documents\PHD\particle_filter_cable_project\data\planning_results\canonical_whip_variable_duration_v1\2026-08-29T064724.928534Z\canonical_whip_variable_duration_v1_final_replay.mp4
